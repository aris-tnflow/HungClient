...
const gjsOptions = {
    ...
    projectData: {
        ...
        pages: [
            {
                name: 'Home page',
                // component: ` <model-viewer camera-controls touch-action="pan-y" src="http://localhost:8082/uploads/3d/file3d/1.glb" id="irmk">`,
            },
        ],
    },
};
    ...
    return (
        ...
        >
            <div className={`flex h-full`} >
                ...
                <RightSidebar className={`gjs-column-r w-[250px] border-l ${MAIN_BORDER_COLOR}`}
                />
            </div>

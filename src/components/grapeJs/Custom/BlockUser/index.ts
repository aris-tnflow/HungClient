...
export default (editor: Editor, opts = {}) => {
  const options: PluginOptions = {
    ...
    buttonSaveLabel: "Lưu",
    buttonResetLabel: "Thiết lập lại",
    buttonEditLabel: "Cài đăt khối",
    buttonDeleteLabel: "Xóa",
    modalSaveTitle: "Lưu",
    modalEditTitle: "Cài đặt",
    messageDeleteBlock: "Are you sure you want to delete this block?",
    newCategoryLabel: "Tạo danh mục mới",
    ...opts
  };
  ...
  const htmlLabel = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
